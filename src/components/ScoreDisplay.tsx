...
const ScoreDisplay: React.FC<ScoreDisplayProps> = ({
  ...
  const getVariantClasses = () => {
    ...
    if (percentage >= 80) return 'text-primary-600 bg-primary-50 border-primary-200'
    if (percentage >= 70) return 'text-warning-600 bg-warning-50 border-warning-200'
      ...
      {showMotivation && (
        <div className="mt-4">
          <p className={cn(
            ...
            percentage >= 60 ? 'text-primary-600' : 
            'text-gray-600'
          )}>
