...
const StudyCardWrapper = (props: any) => (
  <BilingualProvider>
    <StudyCard {...props} />
  </BilingualProvider>
)
...
describe('StudyCard', () => {
  ...
  it('renders study card with note content', () => {
    render(<StudyCardWrapperWrapper {...defaultProps} />)
  ...
  it('displays progress indicator', () => {
    render(<StudyCardWrapper {...defaultProps} />)
  ...
  it('formats bullet points correctly', () => {
    ...
    expect(
      screen.getByText('Membuatkan kita disukai oleh Allah SWT')
    ).toBeInTheDocument()
  ...
  it('calls onPrevious when previous button is clicked', async () => {
    const user = userEvent.setup()
    render(<StudyCardWrapper {...defaultProps} canGoPrevious={true} />)
  ...
  it('disables next button when cannot go next', () => {
    render(<StudyCardWrapper {...defaultProps} canGoNext={false} />)
  ...
  it('disables previous button when cannot go previous', () => {
    render(<StudyCardWrapper {...defaultProps} canGoPrevious={false} />)
  ...
  it('shows completion message when cannot go next', () => {
    ...
    expect(
      screen.getByText('Syabas! Anda telah selesai mempelajari topik ini.')
    ).toBeInTheDocument()
  })
