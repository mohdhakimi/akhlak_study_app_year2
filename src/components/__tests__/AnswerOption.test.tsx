...
describe('AnswerOption', () => {
  ...
  it('does not call onClick when disabled', () => {
    const mockOnClick = vi.fn()
    render(
      <AnswerOption {...defaultProps} onClick={mockOnClick} disabled={true} />
    )
  ...
  it('shows correct icon for correct answer when revealed', () => {
    render(
      <AnswerOption {...defaultProps} isCorrect={true} isRevealed={true} />
    )
  ...
  it('shows correct icon for incorrect answer when revealed', () => {
    render(
      <AnswerOption {...defaultProps} isIncorrect={true} isRevealed={true} />
    )
  ...
  it('handles long option text correctly', () => {
    const longOption =
      'This is a very long option text that should be handled properly and not break the layout'
