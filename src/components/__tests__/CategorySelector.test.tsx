...
describe('CategorySelector', () => {
  ...
  it('shows empty state when no categories', () => {
    ...
    expect(
      screen.getByText('Tiada kategori kuiz tersedia pada masa ini.')
    ).toBeInTheDocument()
  })
  ...
  it('shows instructions section', () => {
    ...
    expect(
      screen.getByText('Pilih jawapan yang paling tepat untuk setiap soalan')
    ).toBeInTheDocument()
  })
  ...
  it('handles category with no questions', () => {
    ...
    render(
      <CategorySelector
        {...defaultProps}
        categories={categoriesWithNoQuestions}
      />
    )
