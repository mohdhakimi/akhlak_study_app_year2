...
describe('LeaderboardTable', () => {
  ...
  it('shows correct category label for different types', () => {
    const { rerender } = render(<LeaderboardTable {...defaultProps} type="quiz" />)
  ...
  it('applies custom className', () => {
    const { container } = render(<LeaderboardTable {...defaultProps} className="custom-class" />)
  ...
  it('displays user avatars with first letter', () => {
    ...
    expect(screen.getByText('A')).toBeInTheDocument() // Ahmad
  ...
  it('shows different colors for different rank ranges', () => {
    ...
    render(<LeaderboardTable {...defaultProps} entries={entriesWithDifferentRanks} />)
  ...
  it('shows footer message', () => {
    ...
    expect(screen.getByText('Papan markah dikemas kini secara automatik')).toBeInTheDocument()
  })
})
