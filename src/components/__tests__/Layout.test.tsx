...
describe('Layout', () => {
  ...
  it('renders with custom title and subtitle', () => {
    render(
      <Layout title="Custom Title" subtitle="Custom Subtitle">
        Main content
      </Layout>
    )
  ...
  it('renders with user info', () => {
    ...
    render(
      <Layout currentUser="John Doe" onUserClick={onUserClick} showUser={true}>
        Main content
      </Layout>
    )
  ...
  it('hides user section when showUser is false', () => {
    render(<Layout showUser={false}>Main content</Layout>)
  ...
  it('renders footer', () => {
    ...
    expect(
      screen.getByText(
        '© 2025 Akhlak Tahun Dua KSRI. Dibangunkan untuk pembelajaran interaktif.'
      )
    ).toBeInTheDocument()
  })
  ...
  it('applies custom header and main className', () => {
    render(
      <Layout headerClassName="custom-header" mainClassName="custom-main">
        Main content
      </Layout>
    )
